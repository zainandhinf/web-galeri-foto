...
@section('content')
    ...
    <div class="album" style="width: 1210px">
        ...
        @foreach ($albums as $album)
            ...
            <div class="wrap-album">
                ...
                <span class="action-album">
                    <a href="/profile/{{ $album->slug }}"><i class="fa-regular fa-eye" style="color: #207be2"></i></a>
                    ...
                    <form action="/deletealbum" method="POST" style="margin-top: -8px; margin-left: -5px">
                        ...
                        <button type="submit" onclick="return confirm('Are you sure you want to delete album?')"
        ...
        <div id="newAlbumForm"
            style="display: none; flex-direction: column; justify-content: center; align-items: center; margin-left: 55px; border: 2px solid black;
                border-radius: 100px; height: 100px; width: 100px;">
            <span class="text-black fs-6 text-center" style="margin-top: 65px">New Album</span>
                            ...
                            <div class="content-post"
                                            ...
                                            <div class="" style="display: flex;flex-direction: column;">
                                                <div class="d-flex" style="height: auto;">
                                                    ...
                                                    <div class="d-flex flex-column" style="margin-top: 30px">
                                                        ...
                                                        <form action="/deletecommentuser" method="POST" class="">
                                                            @method('delete')
                                                            @csrf
                                ...
                                <div class="footer-content z-1"
                                    ...
                                    <div class="popup-comment-box"
                                        ...
                                        <form action="/addcommentuser" method="POST" style="width: 100%; display: flex">
                                            @csrf
